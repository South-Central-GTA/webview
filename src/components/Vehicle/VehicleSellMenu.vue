        ...
        <div class="modal-dialog">
            <div class="modal-content sc-dark text-white">
                <div class="modal-header">
                    ...
                    <button
                        type="button"
                        class="icon-button text-white float-end"
                        @click="close()"
                    >
          ...
          <span v-if="!isGroupVehicle"
          >Bitte fülle alle Felder aus, wenn du über Banküberweisung verkaufen
            möchtest kannst du im nächsten Menu das gewünschte Bankkonto
            auswählen.</span
          >
                    <span v-if="isGroupVehicle"
                    >Bitte fülle alle Felder aus, da es ein Gruppenfahrzeug ist, geht
                    ...
                    <div class="row pt-3 pb-3">
                        ...
                        <div class="col-9">
                            <input
                                ...
                                @focus="onFocus(true)"
                                @blur="onFocus(false)"
                                placeholder="Preis in Dollar (Bsp. 20000)"
                                maxlength="10"
                            />
                        </div>
                    </div>
          ...
          >
                    <span v-if="!isGroupVehicle"
                    >Bitte wähle dein Zielkonto aus auf welchem du die ${{
                            price.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ".")
                        }}
