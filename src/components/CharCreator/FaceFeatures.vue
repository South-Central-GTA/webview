<template>
    <div class="face-features">
        ...
        <div class="row">
            <div class="col-6">
                <h5>Stirn</h5>
                <two-d-slider ref="browSlider" topText="Hoch" bottomText="Runter" leftText="Nach Innen"
                              rightText="Nach Außen" v-on:change-position="updateBrow($event)"/>
            </div>
            <div class="col-6">
                <h5>Nase</h5>
                <two-d-slider ref="noseSlider" topText="Hoch" bottomText="Runter" leftText="Dünn" rightText="Breit"
                              v-on:change-position="updateNose($event)"/>
            </div>
            <div class="col-6">
                <h5>Nasenprofil</h5>
                <two-d-slider ref="noseProfilSlider" topText="Kurvig" bottomText="Gekrümmt" leftText="Kurz"
                              rightText="Lang" v-on:change-position="updateNoseProfil($event)"/>
            </div>
            <div class="col-6">
                <h5>Nasenspitze</h5>
                <two-d-slider ref="noseTipSlider" topText="Hoch" bottomText="Runter" leftText="Links" rightText="Rechts"
                              v-on:change-position="updateNoseTip($event)"/>
            </div>
            <div class="col-6">
                <h5>Wangenknochen</h5>
                <two-d-slider ref="cheekboneSlider" topText="Hoch" bottomText="Runter" leftText="Nach Innen"
                              rightText="Nach Außen" v-on:change-position="updateCheekbone($event)"/>
            </div>
            <div class="col-6">
                <h5>Kiefer</h5>
                <two-d-slider ref="jawSlider" topText="Rund" bottomText="Kantig" leftText="Oval" rightText="Breit"
                              v-on:change-position="updateJaw($event)"/>
            </div>
            <div class="col-6">
                <h5>Kinn</h5>
                <two-d-slider ref="chinSlider" topText="Spitz" bottomText="Eckig" leftText="Nach Innen"
                              rightText="Nach Außen" v-on:change-position="updateChin($event)"/>
            </div>
            <div class="col-6">
                <h5>Kinnform</h5>
                <two-d-slider ref="chinShapeSlider" topText="Rund" bottomText="Grübchen" leftText="Kurz"
                              rightText="Lang" v-on:change-position="updateChinShape($event)"/>
            </div>

            <h5>Augen</h5>
            <input type="range" class="form-range-dark" 
                   min="-100" max="100" v-model="eyesSize"
            ...
            <h5>Wangen</h5>
            <input type="range" class="form-range-dark" 
                   min="-100" max="100" v-model="cheekWidth"
            ...
            <h5>Nacken</h5>
            <input type="range" class="form-range-dark" 
                   min="-100" max="100" v-model="neckWidth"
            ...
            <h5>Lippen</h5>
            <input type="range" class="form-range-dark" 
                   min="-100" max="100" v-model="lipsThickness"
...
import {PositionInterface} from '@/scripts/interfaces/position.interface';
...
export default class FaceFeatures extends Vue {
    ...
    private updateBrow(position: PositionInterface): void {
    ...
    public updateNose(fieldData: PositionInterface) {
    ...
    public updateNoseProfil(fieldData: PositionInterface) {
    ...
    public updateNoseTip(fieldData: PositionInterface) {
    ...
    public updateCheekbone(fieldData: PositionInterface) {
    ...
    public updateJaw(fieldData: PositionInterface) {
    ...
    public updateChin(fieldData: PositionInterface) {
    ...
    public updateChinShape(fieldData: PositionInterface) {
