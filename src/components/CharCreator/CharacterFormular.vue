    ...
    <div class="character-formular">
        ...
        <div class="row g-3">
            <div class="col-md-6">
                ...
                <input @input="send()" v-model="form.profile.firstName" type="text" class="form-control-dark"
                       placeholder="Maxim" maxlength="16"
                       v-bind:class="{ 'is-invalid': firstNameValidation !== 'OKAY' && firstNameValidation !== '' , 'is-valid': firstNameValidation === 'OKAY' }">
            ...
            <div class="col-md-6">
                ...
                <input @input="send()" v-model="form.profile.lastName" type="text" class="form-control-dark"
                       placeholder="Mustermann" maxlength="16"
                       v-bind:class="{ 'is-invalid': lastNameValidation !== 'OKAY' && lastNameValidation !== '', 'is-valid': lastNameValidation === 'OKAY' }">
            ...
            <div class="col-10">
                ...
                <input @input="send()" v-model="form.profile.origin" type="text" class="form-control-dark"
                       placeholder="San Andreas, Los Santos" maxlength="32"
                       v-bind:class="{ 'is-invalid': originValidation !== 'OKAY' && originValidation !== '', 'is-valid': originValidation === 'OKAY' }">
            ...
            <div class="col">
                ...
                <input @input="send()" v-model="age"
                       oninput="if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                       type="number" maxlength="2" class="form-control-dark" placeholder="21"
                       v-bind:class="{ 'is-invalid': ageValidation !== 'OKAY' && ageValidation !== '', 'is-valid': ageValidation === 'OKAY' }">
            ...
            <div class="col-9">
                ...
                <input @input="send()" v-model="form.profile.physique" type="text" class="form-control-dark" maxlength="256"
                       placeholder="Schlaksig, sportlich, dick, dünn, durchschnittlich etc."
                       v-bind:class="{ 'is-invalid': physiqueValidation !== 'OKAY' && physiqueValidation !== '', 'is-valid': physiqueValidation === 'OKAY' }">
            ...
            <div class="col">
                ...
                <div class="input-group">
                    <input @input="send()" v-model="bodySize"
                           oninput="if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                           type="number" maxlength="3" class="form-control-dark" placeholder="180"
                           v-bind:class="{ 'is-invalid': bodySizeValidation !== 'OKAY' && bodySizeValidation !== '', 'is-valid': bodySizeValidation === 'OKAY' }">
            ...
            <div class="col-12">
                ...
                <textarea class="form-control-dark" v-model="form.profile.story" rows="9" style="resize: none;"
                          maxlength="2048" @input="send()"
                          v-bind:class="{ 'is-invalid': storyValidation !== 'OKAY' && storyValidation !== '', 'is-valid': storyValidation === 'OKAY' }">></textarea>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-4">
                        <div class="input-group">
                            ...
                            <input @input="send()" v-model="form.startMoney" type="number" class="form-control-dark"
                                   readonly>
                        </div>
                    </div>
                    <div class="col-4">
