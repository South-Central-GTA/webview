...
export default class CharacterAppearance extends Vue {
    ...
    private maleHairlist = [
        {id: 0, name: "Glatze"},
        {id: 1, name: "Kurzgeschoren"},
        {id: 2, name: "Iro, modisch"},
        {id: 3, name: "Hipster"},
        {id: 4, name: "Seitenscheitel"},
        {id: 5, name: "Kurzhaarschnitt"},
        {id: 6, name: "Bikerfrisur"},
        {id: 7, name: "Pferdeschwanz"},
        {id: 8, name: "Flechtreihen"},
        {id: 9, name: "Gelfrisur"},
        {id: 10, name: "Kurz gekämmt"},
        {id: 11, name: "Stachelfrisur"},
        {id: 12, name: "Cäsarenfrisur"},
        {id: 13, name: "Zerzaust"},
        {id: 14, name: "Dreadlocks"},
        {id: 15, name: "Langhaarfrisur"},
        {id: 16, name: "Zottellocken"},
        {id: 17, name: "Surferfrisur"},
        {id: 18, name: "Seitenscheitel"},
        {id: 19, name: "Hochgekämmt"},
        {id: 20, name: "Gelfrisur, lang"},
        {id: 21, name: "Junger Hipster"},
        {id: 22, name: "Vokuhila"},
        {id: 24, name: "Dreads 1"},
        {id: 25, name: "Dreads 2"},
        {id: 26, name: "Dreads 3"},
    ...
    private femaleHairlist = [
        {id: 0, name: "Glatze"},
        {id: 1, name: "Kurz"},
        {id: 2, name: "Stufenbob"},
        {id: 3, name: "Zöpfe"},
        {id: 4, name: "Pferdeschwanz"},
        {id: 5, name: "Iro, geflochten"},
        {id: 6, name: "Flechtzöpfe"},
        {id: 7, name: "Bob"},
        {id: 8, name: "Iro, modisch"},
        {id: 9, name: "Bananenfrisur"},
        {id: 10, name: "Langer Bob"},
        {id: 11, name: "Locker"},
        {id: 12, name: "Pixieschnitt"},
        {id: 13, name: "Rasierter Pony"},
        {id: 14, name: "Dutt"},
        {id: 15, name: "Lockiger Bob"},
        {id: 16, name: "Pin-up-Girl"},
        {id: 17, name: "Wilder Dutt"},
        {id: 19, name: "Kleiner Dutt"},
        {id: 20, name: "Gelockter Bob"},
        {id: 21, name: "Langer Pony"},
        {id: 22, name: "Flechtdutt"},
        {id: 23, name: ""},
        {id: 25, name: ""},
        {id: 26, name: ""},
        {id: 27, name: ""},
    ...
    private facialHairNames = [
        ...
        "Dünner Henriquatre",
        "Mongolenbart",
        "Stift und Koteletten",
        "Kinnstreifen",
        "Balbo und Backenbart",
        "Koteletten",
        "Ungepflegter Bart",
        "Gezwirbelt",
        "Gezwirbelt & Dreitagebart",
        "Langer Schnäuzer",
        "Faustisch",
        "Otto & Kinnbart",
        "Otto & Vollbart",
    ...
    public setCharacterAppearances(appearances: AppearancesInterface): void {
        ...
        this.eyeColorMenu.setAppearance({
            value: this.appearances.eyeColor,
            opacity: 1,
            primaryColor: 0,
        });
