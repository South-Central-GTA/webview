    ...
    <div class="phone-manage-permission-bank-account">
        ...
        <div class="row permission-block">
            <div>
                ...
                <div class="btn-group">
                    <button type="button" class="btn" @click="addPermission(depositPermission)"
                            v-bind:class="{ 'btn-success': canDeposit, 'btn-outline-success': !canDeposit }">Ja
                    </button>
                    <button type="button" class="btn" @click="removePermission(depositPermission)"
                            v-bind:class="{ 'btn-danger': !canDeposit, 'btn-outline-danger': canDeposit }">Nein
                    </button>
                </div>
            </div>
            <div>
                ...
                <div class="btn-group">
                    <button type="button" class="btn" @click="addPermission(withdrawPermission)"
                            v-bind:class="{ 'btn-success': canWithdraw, 'btn-outline-success': !canWithdraw }">Ja
                    </button>
                    <button type="button" class="btn" @click="removePermission(withdrawPermission)"
                            v-bind:class="{ 'btn-danger': !canWithdraw, 'btn-outline-danger': canWithdraw }">Nein
                    </button>
                </div>
            </div>
            <div>
                ...
                <div class="btn-group">
                    <button type="button" class="btn" @click="addPermission(transferPermission)"
                            v-bind:class="{ 'btn-success': canTransfer, 'btn-outline-success': !canTransfer }">Ja
                    </button>
                    <button type="button" class="btn" @click="removePermission(transferPermission)"
                            v-bind:class="{ 'btn-danger': !canTransfer, 'btn-outline-danger': canTransfer }">Nein
                    </button>
                </div>
            </div>
            <div>
                ...
                <div class="btn-group">
                    <button type="button" class="btn" @click="addPermission(seeTransactionPermission)"
                            v-bind:class="{ 'btn-success': canSeeTransaction, 'btn-outline-success': !canSeeTransaction }">
                        Ja
                    </button>
                    <button type="button" class="btn" @click="removePermission(seeTransactionPermission)"
                            v-bind:class="{ 'btn-danger': !canSeeTransaction, 'btn-outline-danger': canSeeTransaction }">
                        Nein
                    </button>
                </div>
            </div>
            <div>
                ...
                <div class="btn-group">
                    <button type="button" class="btn" @click="addPermission(managePermission)"
                            v-bind:class="{ 'btn-success': canManage, 'btn-outline-success': !canManage }">Ja
                    </button>
                    <button type="button" class="btn" @click="removePermission(managePermission)"
                            v-bind:class="{ 'btn-danger': !canManage, 'btn-outline-danger': canManage }">Nein
                    </button>
                </div>
            </div>
            <div class="text-center">
                <button type="button" class="btn btn-dark mb-4" @click="removeAccess()">Zugriff entfernen</button>
            </div>
        </div>
    </div>
</template>
...
export default class PhoneManagePermissionBankAccount extends Vue {
    ...
    public mounted(): void {
        banking.getInstance().onChange.on((bankAccounts: BankAccountInterface[]) => this.updateBankAccounts(bankAccounts));
    }
