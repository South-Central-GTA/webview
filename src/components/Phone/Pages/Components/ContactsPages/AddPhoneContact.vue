    ...
    <div class="add-phone-contact">
        <div class="center">
            ...
            <input ref="nameInput" type="text" class="form-control"
                   @focus="onFocus(true)" @blur="onFocus(false)" placeholder="Max Mustermann" maxlength="32"
            ...
            <input ref="numberInput" class="form-control"
                   ...
                   type="number"
                   @blur="onFocus(false)" placeholder="55512345678" maxlength="11"
            ...
            <div class="add-button-box">
                <button type="button" class="btn btn-secondary" @click="addContact()">Kontakt erstellen</button>
            </div>
        </div>
    </div>
</template>
...
import {UID, isNumeric, allowOnlyNumbers, onFocus} from '@/scripts/helpers/helpers';
