        ...
        <div class="content row m-4">
            <div class="col">
                <mdc-file 
                    ...
                    v-on:close="onCloseFile()"></mdc-file>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content bg-white overflow-hidden" style="border-radius: 0 !important;">
                                <div class="p-4">
                                    ...
                                    <span>Sind Sie sich sicher das diese Datei gelöscht werden soll?</span>
                                </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content bg-white overflow-hidden" style="border-radius: 0 !important;">
                                <div class="p-4">
                                    ...
                                    <span class="pt-4">Welcher Rang soll in dem Ordner was bearbeiten dürfen?</span>
                                    <select class="form-select" @change="onChangeWritePermission($event)">
                                        <option
                                            v-for="groupRank in groupRanks" 
                                            v-bind:key="groupRank.level"
                                            :value="groupRank.level"
                ...
                <div v-if="!isFileOpen">
                            ...
                            <tbody>
                                <tr v-for="file in files" v-bind:key="file.id" class="entry">
                                    ...
                                    <td class="pointer-event">
                                        <button class="icon-button" @click="editFileName(file)" v-if="file.creatorCharacterId === characterId || isOperator">
                    ...
                    <div class="pb-5 position-absolute bottom-0">
                        <button type="button" v-if="directoryId === null" @click="createDirectory()">Ordner erstellen</button>
                        <button type="button" v-if="directoryId !== null" @click="createFile()">Textdatei erstellen</button>
                    </div>
                </div>
            </div>
        </div>
...
export default class MdcFiles extends Vue {
    ...
    private requestSetAccessPermission(file: FileInterface): void {
        eventBusService.sendEventWithResponse<FileSystemRankSetup>("filesystem:getranksetup", this.groupId, file.id)
