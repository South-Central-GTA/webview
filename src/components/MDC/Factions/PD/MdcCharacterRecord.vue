    ...
    <div class="mdc-character-record">
        <div class="content h-100 row m-4">
            <div class="col-4">
                ...
                <p v-if="vehicles.length === 0"><b>Fahrzeuge:</b> Keine Suchergebnisse!</p>
                ...
                <p><b>Lizenzen:</b> <span v-if="!hasDrivingLicense && !hasBoatsLicense && !hasFlyingLicense && !hasWeaponLicense">Keine Suchergebnisse!</span></p>
                <div class="row">
            ...
            <div class="col-4">
                ...
                <div v-if="records.length !== 0" class="big-list-holder">
                    <p v-for="record in records" v-bind:key="record.id">
                        <button type="button" v-if="isOperator" @click="deleteRecord(record.id)">X</button>
                        {{ record.reason }}<br> <span class="date-text">{{ record.creatorCharacterName }} - {{ getDate(record.createdAtJson) }}</span>
                    </p>
                </div>
