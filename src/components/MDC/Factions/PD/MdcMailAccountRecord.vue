<template>
    <div class='mdc-mail-account-record'>
...
import {MailAccountGroupAccessInterface} from "@/scripts/interfaces/mail/mail-account-group-access.interface";
...
export default class MdcMailAccountRecord extends Vue {
