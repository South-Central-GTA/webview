        ...
        <div class="row g-3 mt-2">
            <div class="col-6">
                ...
                <div class="btn-group w-100">
                    <button type="button" class="btn" @click="addPermission(bankingDepositPermission)"
                            v-bind:class="{ 'btn-success': canBankDeposit, 'btn-outline-success': !canBankDeposit }">
                        Ja
                    </button>
                    <button type="button" class="btn" @click="removePermission(bankingDepositPermission)"
                            v-bind:class="{ 'btn-danger': !canBankDeposit, 'btn-outline-danger': canBankDeposit }">
                        Nein
                    </button>
                </div>
            </div>
            <div class="col-6">
                ...
                <div class="btn-group w-100">
                    <button type="button" class="btn" @click="addPermission(bankingWithdrawPermission)"
                            v-bind:class="{ 'btn-success': canBankWithdraw, 'btn-outline-success': !canBankWithdraw }">
                        Ja
                    </button>
                    <button type="button" class="btn" @click="removePermission(bankingWithdrawPermission)"
                            v-bind:class="{ 'btn-danger': !canBankWithdraw, 'btn-outline-danger': canBankWithdraw }">
                        Nein
                    </button>
                </div>
            </div>
            <div class="col-6">
                ...
                <div class="btn-group w-100">
                    <button type="button" class="btn" @click="addPermission(bankingTransferPermission)"
                            v-bind:class="{ 'btn-success': canBankTransfer, 'btn-outline-success': !canBankTransfer }">
                        Ja
                    </button>
                    <button type="button" class="btn" @click="removePermission(bankingTransferPermission)"
                            v-bind:class="{ 'btn-danger': !canBankTransfer, 'btn-outline-danger': canBankTransfer }">
                        Nein
                    </button>
                </div>
            </div>
            <div class="col-6">
                ...
                <div class="btn-group w-100">
                    <button type="button" class="btn" @click="addPermission(bankingSeeTransactionsPermission)"
                            v-bind:class="{ 'btn-success': canBankSeeTransactions, 'btn-outline-success': !canBankSeeTransactions }">
                        Ja
                    </button>
                    <button type="button" class="btn" @click="removePermission(bankingSeeTransactionsPermission)"
                            v-bind:class="{ 'btn-danger': !canBankSeeTransactions, 'btn-outline-danger': canBankSeeTransactions }">
                        Nein
                    </button>
                </div>
            </div>
            <div class="col-6">
                ...
                <div class="btn-group w-100">
                    <button type="button" class="btn" @click="addPermission(mailingReading)"
                            v-bind:class="{ 'btn-success': canReadMails, 'btn-outline-success': !canReadMails }">Ja
                    </button>
                    <button type="button" class="btn" @click="removePermission(mailingReading)"
                            v-bind:class="{ 'btn-danger': !canReadMails, 'btn-outline-danger': canReadMails }">Nein
                    </button>
                </div>
            </div>
            <div class="col-6">
                ...
                <div class="btn-group w-100">
                    <button type="button" class="btn" @click="addPermission(mailingSending)"
                            v-bind:class="{ 'btn-success': canSendMails, 'btn-outline-success': !canSendMails }">Ja
                    </button>
                    <button type="button" class="btn" @click="removePermission(mailingSending)"
                            v-bind:class="{ 'btn-danger': !canSendMails, 'btn-outline-danger': canSendMails }">Nein
                    </button>
                </div>
            </div>
            <div class="col-6">
                ...
                <div class="btn-group w-100">
                    <button type="button" class="btn" @click="addPermission(mailingDeleting)"
                            v-bind:class="{ 'btn-success': canDeleteMails, 'btn-outline-success': !canDeleteMails }">
                        Ja
                    </button>
                    <button type="button" class="btn" @click="removePermission(mailingDeleting)"
                            v-bind:class="{ 'btn-danger': !canDeleteMails, 'btn-outline-danger': canDeleteMails }">
                        Nein
                    </button>
                </div>
            </div>
            <div class="col-6">
                ...
                <div class="btn-group w-100">
                    <button type="button" class="btn" @click="addPermission(manageMembersPermission)"
                            v-bind:class="{ 'btn-success': canManageMembers, 'btn-outline-success': !canManageMembers }">
                        Ja
                    </button>
                    <button type="button" class="btn" @click="removePermission(manageMembersPermission)"
                            v-bind:class="{ 'btn-danger': !canManageMembers, 'btn-outline-danger': canManageMembers }">
                        Nein
                    </button>
                </div>
            </div>
            <div class="col-6">
                ...
                <div class="btn-group w-100">
                    <button type="button" class="btn" @click="addPermission(invitePermission)"
                            v-bind:class="{ 'btn-success': canInvite, 'btn-outline-success': !canInvite }">Ja
                    </button>
                    <button type="button" class="btn" @click="removePermission(invitePermission)"
                            v-bind:class="{ 'btn-danger': !canInvite, 'btn-outline-danger': canInvite }">Nein
                    </button>
                </div>
            </div>
            <div class="col-6">
                ...
                <div class="btn-group w-100">
                    <button type="button" class="btn" @click="addPermission(uninvitePermission)"
                            v-bind:class="{ 'btn-success': canUninvite, 'btn-outline-success': !canUninvite }">Ja
                    </button>
                    <button type="button" class="btn" @click="removePermission(uninvitePermission)"
                            v-bind:class="{ 'btn-danger': !canUninvite, 'btn-outline-danger': canUninvite }">Nein
                    </button>
                </div>
            </div>
            <div class="col-6">
                ...
                <div class="btn-group w-100">
                    <button type="button" class="btn" @click="addPermission(sellVehiclesPermission)"
                            v-bind:class="{ 'btn-success': canSellVehicles, 'btn-outline-success': !canSellVehicles }">
                        Ja
                    </button>
                    <button type="button" class="btn" @click="removePermission(sellVehiclesPermission)"
                            v-bind:class="{ 'btn-danger': !canSellVehicles, 'btn-outline-danger': canSellVehicles }">
                        Nein
                    </button>
                </div>
            </div>
            ...
            <div class="col-6" v-if="isCompany">
                ...
                <div class="btn-group w-100">
                    <button type="button" class="btn" @click="addPermission(changeDeliveryVisibilityPermission)"
                            v-bind:class="{ 'btn-success': canChangeDeliveryVisibility, 'btn-outline-success': !canChangeDeliveryVisibility }">
                        Ja
                    </button>
                    <button type="button" class="btn" @click="removePermission(changeDeliveryVisibilityPermission)"
                            v-bind:class="{ 'btn-danger': !canChangeDeliveryVisibility, 'btn-outline-danger': canChangeDeliveryVisibility }">
                        Nein
                    </button>
                </div>
            </div>
            <div class="col-6" v-if="isCompany">
                ...
                <div class="btn-group w-100">
                    <button type="button" class="btn" @click="addPermission(orderProductsPermission)"
                            v-bind:class="{ 'btn-success': canOrderProducts, 'btn-outline-success': !canOrderProducts }">
                        Ja
                    </button>
                    <button type="button" class="btn" @click="removePermission(orderProductsPermission)"
                            v-bind:class="{ 'btn-danger': !canOrderProducts, 'btn-outline-danger': canOrderProducts }">
                        Nein
                    </button>
                </div>
            </div>
            <div class="col-6" v-if="isCompany">
                ...
                <div class="btn-group w-100">
                    <button type="button" class="btn" @click="addPermission(buyLicensesPermission)"
                            v-bind:class="{ 'btn-success': canBuyLicenses, 'btn-outline-success': !canBuyLicenses }">
                        Ja
                    </button>
                    <button type="button" class="btn" @click="removePermission(buyLicensesPermission)"
                            v-bind:class="{ 'btn-danger': !canBuyLicenses, 'btn-outline-danger': canBuyLicenses }">
                        Nein
                    </button>
                </div>
            </div>
            <div class="col-6" v-if="isCompany">
                ...
                <div class="btn-group w-100">
                    <button type="button" class="btn" @click="addPermission(sellLicensesPermission)"
                            v-bind:class="{ 'btn-success': canSellLicenses, 'btn-outline-success': !canSellLicenses }">
                        Ja
                    </button>
                    <button type="button" class="btn" @click="removePermission(sellLicensesPermission)"
                            v-bind:class="{ 'btn-danger': !canSellLicenses, 'btn-outline-danger': canSellLicenses }">
                        Nein
                    </button>
                </div>
            </div>
            ...
            <div class="col-6" v-if="isVehicleDealer">
                ...
                <div class="btn-group w-100">
                    <button type="button" class="btn" @click="addPermission(orderVehiclesPermission)"
                            v-bind:class="{ 'btn-success': canOrderVehicles, 'btn-outline-success': !canOrderVehicles }">
                        Ja
                    </button>
                    <button type="button" class="btn" @click="removePermission(orderVehiclesPermission)"
                            v-bind:class="{ 'btn-danger': !canOrderVehicles, 'btn-outline-danger': canOrderVehicles }">
                        Nein
                    </button>
                </div>
            </div>
            <div class="col-6" v-if="isVehicleDealer">
                ...
                <div class="btn-group w-100">
                    <button type="button" class="btn" @click="addPermission(storeVehiclesPermission)"
                            v-bind:class="{ 'btn-success': canStoreVehicles, 'btn-outline-success': !canStoreVehicles }">
                        Ja
                    </button>
                    <button type="button" class="btn" @click="removePermission(storeVehiclesPermission)"
                            v-bind:class="{ 'btn-danger': !canStoreVehicles, 'btn-outline-danger': canStoreVehicles }">
                        Nein
                    </button>
                </div>
            </div>
            <div class="col-6" v-if="isFaction">
                ...
                <div class="btn-group w-100">
                    <button type="button" class="btn" @click="addPermission(mdcOperatorPermission)"
                            v-bind:class="{ 'btn-success': hasMdcOperator, 'btn-outline-success': !hasMdcOperator }">
                        Ja
                    </button>
                    <button type="button" class="btn" @click="removePermission(mdcOperatorPermission)"
                            v-bind:class="{ 'btn-danger': !hasMdcOperator, 'btn-outline-danger': hasMdcOperator }">
                        Nein
                    </button>
                </div>
            </div>
...
export default class GroupPermissionSettingsPage extends Vue {
    ...
    public mounted(): void {
        groupService.getInstance().AllGroupsChanged.on((groups: GroupInterface[] | undefined) => this.updateGroups(groups));
    }
