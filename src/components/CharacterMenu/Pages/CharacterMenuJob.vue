<template>
    <div class="character-menu-job">
        ...
        <p class="card-text">Charaktere arbeiten bei uns auf dem Server auf definierter Basis wodurch du dich
            auf das Wesentliche fokusieren kannst, Rollenspiel!
            Währenddessen du OOC arbeitest bzw. in der Schule bist oder auch nur Zuhause chillst, würde dein
            Charakter ja auch arbeiten, oder eben nicht.</p>
        ...
        <div :hidden="!isUnemployed">
            ...
            <p class="card-text">Wähle das Bankkonto aus auf welchem das Gehalt von deinem definierten Beruf
            ...
            <div class="bottom-0 position-absolute pb-5">
                <p class="card-text text-muted">
                    Solltest du mehr Rollenspiel wollen, können wir dir nur empfehlen eine unserer spielerbasierten
                    Unternehmen aufzusuchen und dort IC einen Job dir zu besorgen. Sie bezahlen besser und du hast
                    die beste Spielerfahrung.
                </p>
        ...
        <div :hidden="isUnemployed">
            <div v-if="jobId !== 1">
                ...
                <hr>
                <p class="card-text pt-2">Was genau dein Charakter beruflich in diesem Berufsfeld macht ist dir
                    überlassen, definiere es für deinen Charakter realistisch passend.</p>
            </div>
            <div v-else>
                <p class="card-text">{{ jobName }}</p>
                <hr>
            ...
            <div class="align-bottom">
                <p class="card-text">Wähle das Bankkonto aus auf welchem das Gehalt von deinem definierten
                    Beruf überwiesen werden soll:</p>
    
                <select-bank-account v-on:change-bank-account="changeBankAccount($event)"
                                     v-on:setup="setBankAccount($event)"/>
