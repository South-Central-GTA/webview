<template>
    <div class="character-menu-animations">
        <h2>Animationen</h2>
        <input @input="search()" v-model="searchBar"
               type="text" class="form-control-dark mb-2" placeholder="Suche nach einem Namen"/>
                    ...
                    <tr v-for="animation in animations" v-bind:key="animation.id" class="entry">
                        ...
                        <td>
                            <button type="button" class="btn w-100" 
                                    v-bind:class="{ 'btn-outline-primary': !hasAnimation(animation.id), 'btn-primary': hasAnimation(animation.id) }"
